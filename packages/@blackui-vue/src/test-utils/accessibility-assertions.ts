...
export function getMenuButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="blackui-menu-button-"]')
}
...
export function getComboboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="blackui-combobox-label"]')
}

export function getComboboxButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="blackui-combobox-button-"]')
}
...
export function getListboxLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="blackui-listbox-label"]')
}

export function getListboxButton(): HTMLElement | null {
  return document.querySelector('button,[role="button"],[id^="blackui-listbox-button-"]')
}
...
export function getSwitchLabel(): HTMLElement | null {
  return document.querySelector('label,[id^="blackui-switch-label"]')
}
...
export function getDisclosureButton(): HTMLElement | null {
  return document.querySelector('[id^="blackui-disclosure-button-"]')
}

export function getDisclosurePanel(): HTMLElement | null {
  return document.querySelector('[id^="blackui-disclosure-panel-"]')
}
...
export function getPopoverButton(): HTMLElement | null {
  return document.querySelector('[id^="blackui-popover-button-"]')
}

export function getPopoverPanel(): HTMLElement | null {
  return document.querySelector('[id^="blackui-popover-panel-"]')
}

export function getPopoverOverlay(): HTMLElement | null {
  return document.querySelector('[id^="blackui-popover-overlay-"]')
}
...
export function getDialogTitle(): HTMLElement | null {
  return document.querySelector('[id^="blackui-dialog-title-"]')
}

export function getDialogDescription(): HTMLElement | null {
  return document.querySelector('[id^="blackui-description-"]')
}

export function getDialogOverlay(): HTMLElement | null {
  return document.querySelector('[id^="blackui-dialog-overlay-"]')
}

export function getDialogBackdrop(): HTMLElement | null {
  return document.querySelector('[id^="blackui-dialog-backdrop-"]')
}

export function getDialogOverlays(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="blackui-dialog-overlay-"]'))
}
...
export function getRadioGroupLabel(): HTMLElement | null {
  return document.querySelector('[id^="blackui-label-"]')
}

export function getRadioGroupOptions(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="blackui-radiogroup-option-"]'))
}
...
export function getTabs(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="blackui-tabs-tab-"]'))
}

export function getPanels(): HTMLElement[] {
  return Array.from(document.querySelectorAll('[id^="blackui-tabs-panel-"]'))
}
...
export function assertTabs(
  ...
  try {
    ...
    let activeTab = Array.from(list.querySelectorAll('[id^="blackui-tabs-tab-"]'))[active]
