  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      assertPopoverButton({
        ...
        attributes: { id: 'blackui-popover-button-1' },
      })
  ...
  describe('`Enter` key', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertPopoverPanel({
          state: PopoverState.Visible,
          attributes: { id: 'blackui-popover-panel-3' },
        })
    ...
    suppressConsoleLogs(async () => {
      ...
      assertPopoverPanel(
        ...
        document.querySelector(
          '[data-testid="popover-a"] [id^="blackui-popover-panel-"]'
        ) as HTMLElement
      )
      ...
      assertPopoverPanel(
        { state: PopoverState.InvisibleUnmounted },
        document.querySelector(
          '[data-testid="popover-b"] [id^="blackui-popover-panel-"]'
        ) as HTMLElement
      )
