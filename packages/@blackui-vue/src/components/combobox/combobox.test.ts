  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      assertComboboxButton({
        ...
        attributes: { id: 'blackui-combobox-button-2' },
      })
  ...
  describe('Combobox', () => {
    ...
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertComboboxInput({
          state: ComboboxState.InvisibleUnmounted,
          attributes: { id: 'blackui-combobox-input-1', disabled: '' },
        })
  ...
  describe('ComboboxLabel', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertComboboxButton({
          state: ComboboxState.InvisibleUnmounted,
          attributes: { id: 'blackui-combobox-button-3' },
        })
        assertComboboxLabel({
          attributes: { id: 'blackui-combobox-label-1' },
    ...
    describe('`Enter` key', () => {
      it(
        ...
        suppressConsoleLogs(async () => {
          ...
          assertComboboxList({
            state: ComboboxState.Visible,
            attributes: { id: 'blackui-combobox-options-3' },
          })
          assertActiveElement(getComboboxInput())
          assertComboboxButtonLinkedWithCombobox()
