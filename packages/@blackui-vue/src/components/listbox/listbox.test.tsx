  ...
  it(
    ...
    suppressConsoleLogs(async () => {
      ...
      assertListboxButton({
        ...
        attributes: { id: 'blackui-listbox-button-1' },
      })
  ...
  describe('ListboxLabel', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertListboxButton({
          state: ListboxState.InvisibleUnmounted,
          attributes: { id: 'blackui-listbox-button-2' },
        })
        assertListboxLabel({
          attributes: { id: 'blackui-listbox-label-1' },
  ...
  describe('`Enter` key', () => {
    it(
      ...
      suppressConsoleLogs(async () => {
        ...
        assertListbox({
          state: ListboxState.Visible,
          attributes: { id: 'blackui-listbox-options-2' },
        })
        assertActiveElement(getListbox())
        assertListboxButtonLinkedWithListbox()
