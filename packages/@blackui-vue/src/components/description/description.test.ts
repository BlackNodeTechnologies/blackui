...
it('should be possible to use useDescriptions and a single Description, and have them linked', async () => {
  ...
  expect(format(container.firstElementChild)).toEqual(
    format(html`
      <div>
        <div aria-describedby="blackui-description-1">
          <p id="blackui-description-1">I am a description</p>
          <span>Contents</span>
        </div>
      </div>
    `)
...
it('should be possible to use useDescriptions and multiple Description components, and have them linked', async () => {
  ...
  expect(format(container.firstElementChild)).toEqual(
    format(html`
      <div>
        <div aria-describedby="blackui-description-1 blackui-description-2">
          <p id="blackui-description-1">I am a description</p>
          <span>Contents</span>
          <p id="blackui-description-2">I am also a description</p>
        </div>
      </div>
    `)
  )
...
it('should be possible to update a prop from the parent and it should reflect in the Description component', async () => {
  ...
  expect(format(container.firstElementChild)).toEqual(
    format(html`
      <div>
        <div aria-describedby="blackui-description-1">
          <p data-count="0" id="blackui-description-1">I am a description</p>
          <button>+1</button>
        </div>
      </div>
    `)
  ...
  expect(format(container.firstElementChild)).toEqual(
    format(html`
      <div>
        <div aria-describedby="blackui-description-1">
          <p data-count="1" id="blackui-description-1">I am a description</p>
          <button>+1</button>
        </div>
      </div>
    `)
